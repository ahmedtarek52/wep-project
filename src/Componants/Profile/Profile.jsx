                        ...
                        <div className="col-12">
                           <div className="card widget-card border-light shadow-sm">
                              ...
                              <div className="card-body">
                                 <div className="text-center mb-3">{/* <img src={profile.profilephoto.url} className="img-fluid w-25 rounded-circle" alt="Luna John"/> */}</div>
                           ...
                           <div className="tab-content pt-4" id="profileTabContent">
                              <div className="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabIndex="0">
                                 ...
                                 <p className="lead mb-3">
                                    Ethan Leo is a seasoned and results-driven Project Manager who brings experience and expertise to project management. With a proven track record of successfully
                                    delivering complex projects on time and within budget, Ethan Leo is the go-to professional for organizations seeking efficient and effective project leadership.
                                 </p>
