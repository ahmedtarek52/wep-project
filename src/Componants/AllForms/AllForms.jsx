...
export default function AllForms() {
  return (
   <>
    ...
    <header className=" custom-bg px-4 py-6 text-primary-foreground md:px-6 md:py-8">
    ...
    <div className="col-sm-4 mb-4">
      <div className="card text-center h-100">
        <div className="card-body">
          <div className="mb-3  custom-color">
          ...
          <Button to='/payment' className='mt-3'>Donate with Visa</Button>
    ...
    <div className="col-sm-4 mb-4">
      <div className="card text-center h-100">
        <div className="card-body">
          ...
          <Button to='' className='mt-3'>Donate with Wallet</Button>
        </div>
      </div>
    </div>
    <div className="col-sm-4 mb-4">
      <div className="card text-center h-100">
        <div className="card-body">
          ...
          <Button to='/donationform'  className='mt-3'>Donate Now</Button>
        </div>
      </div>
    </div>
  </div>
